...
export class CanvasController {
    ...
    generateShape(action: String, x: number, y: number) {
        this.model.addShape(
            this.shapeFactory.createShapeFromClick(action, x, y));
    }
    ...
    //gets shape and drags it to new coordinatesa
    dragShape(shape: Shape, x: number, y: number) {
